...
for (const simpson of simpsons) {
    ...
    userName.innerText = simpson.name;


    let userSurname = document.createElement('div');
    userSurname.innerText = simpson.surname;


    let userAge = document.createElement('div');
    userAge.innerText = simpson.age;


    let userInfo = document.createElement('div');
    userInfo.innerText = simpson.info;


    let userImage = document.createElement('img');
    userImage.src = simpson.photo;

    document.body.appendChild(divElement);
    divElement.appendChild(userName);
    divElement.appendChild(userSurname);
    divElement.appendChild(userAge);
    divElement.appendChild(userInfo);
...
for (const coursesItem of coursesArray) {
    ...
    subject.classList.add('wrap');


    let divTitle = document.createElement('div');
    divTitle.innerText = coursesItem.title;
    divTitle.classList.add('title');

    let divMoth = document.createElement('div');
    divMoth.innerText = coursesItem.monthDuration;
    divMoth.classList.add('month');

    let divHour = document.createElement('div');
    divHour.innerText = coursesItem.hourDuration;
    divHour.classList.add('hour');

    let divModule = document.createElement('div');
    divModule.classList.add('module');

    for (const courseItem of coursesItem.modules) {
        let liModule = document.createElement('li');
        liModule.innerText = courseItem;
        liModule.classList.add('liModule');
